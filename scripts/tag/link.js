...
function link(args) {
  ...
  return `<div calss='anzhiyu-tag-link'><a class="tag-Link" target="_blank" href="${urlFor(link)}">
    <div class="tag-link-tips">${InsideStation ? "站内地址" : "🙄引用站外地址，不保证站点的可用性和安全性"}</div>
    <div class="tag-link-bottom">
        <div class="tag-link-left" style="${imgUrl ? `background-image: url(${InsideStation ? "/img/512.png" : imgUrl})` : ""
    }">
